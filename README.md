...
**v1.1.0** — Claude Code에 더해 **Codex CLI · Codex 데스크톱 앱** 세션도 함께 표시합니다. 이름표 앞의 아이콘과 초록 테두리가 Codex 펫입니다. 자세한 내용은 [Codex 지원](#codex-지원) 절 참고.
...
- **클릭 → 패널** (위쪽 **Claude / Codex** 선택이 명령·잡담·사용량에 적용됩니다. 목록은 항상 둘 다 표시)
  ...
  - **⚙️ 설정** — 펫 이미지 변경, 크기, 좌우 반전, 배경 자동 제거, 알림 링/스포트라이트 토글.
...
- **이름표** — 세션 이름(없으면 작업 폴더의 최하위 디렉토리명). 앞의 아이콘이 서비스(Claude/Codex), Codex 펫은 초록 테두리. Codex **데스크톱 앱** 세션엔 작은 모니터 배지가 붙습니다.
...
회전축이 캐릭터 **바닥 중앙**에 고정돼 어떤 이미지든 바닥을 딛고 갸우뚱합니다.
